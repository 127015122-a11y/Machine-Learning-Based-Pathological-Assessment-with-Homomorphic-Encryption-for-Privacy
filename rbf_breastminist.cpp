...
int main() {
    ...
    vector<vector<double>> support_vectors = read_2d_matrix_from_file("E:\\rbf_image_breast\\support_vectors_rbf.txt");
    ...
    vector<double> dual_coeffs = read_double_data_from_file("E:\\rbf_image_breast\\dual_coeff_rbf.txt");
    vector<double> b_vec = read_double_data_from_file("E:\\rbf_image_breast\\intercept_rbf.txt");
    ...
    vector<double> x = read_double_data_from_file("E:\\rbf_image_breast\\xtest_rbf.txt");
    vector<double> y_ground_truth = read_double_data_from_file("E:\\rbf_image_breast\\ytest_rbf.txt");
    resize_double_vector(y_ground_truth, n);
    vector<double> y_expected_score = read_double_data_from_file("E:\\rbf_image_breast\\yclassificationscore.txt");
