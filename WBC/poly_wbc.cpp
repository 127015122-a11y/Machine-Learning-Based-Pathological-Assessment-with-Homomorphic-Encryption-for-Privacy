...
int main(){
    ...
    double gamma=2;
    uint32_t degree=3;
    vector<vector<double>> support_vectors=read_2d_matrix_from_file("E:\\svm_poly\\support_vectors_polybreast.txt");
    ...
    vector<double> dual_coeffs=read_double_data_from_file("E:\\svm_poly\\dual_coeff_polybreast.txt");
    vector<double> bias=read_double_data_from_file("E:\\svm_poly\\intercept_polybreast.txt");
    vector<double> x=read_double_data_from_file("E:\\svm_poly\\xtest_polybreast.txt");
